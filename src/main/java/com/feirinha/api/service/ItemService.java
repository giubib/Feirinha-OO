...
import com.feirinha.exception.ConflictException;
import com.feirinha.exception.NotFoundException;
...
public class ItemService {
    ...
    public Item update(Long id, ItemDTO dto) {
        ...
        boolean nameChanged = !item.getName().equalsIgnoreCase(dto.getName());
